...
const COVERAGE: CovGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'FCC-ID / schematics / changelog lookup', status: 'planned', note: 'recon gap' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Service enumeration / run-command-in-emulation', status: 'planned', note: 'interactive gap' },
      { name: 'Saved emulation presets', status: 'planned', note: 'convenience' },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: 'Drive the emulated web UI (cmd-inj / authz / traversal)',
        status: 'planned',
        note: 'top gap — webprobe',
      },
