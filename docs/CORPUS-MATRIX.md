...
Generada: 2026-08-23T18:36:26.572Z

23 muestras · 8 clases · 376 celdas de etapa aplicable.
...
| W3 · Auxiliary-partition secrets | ○ | ○ | ○ | ✓3 | ✓4 | ○ | ✓2 | ○ | ○ | ✓2 |
| W2 · SBOM / CVE | ⊘ | ⊘ | ⊘ | ✓18 | ✓24 | ○ | ○ | ○ | ○ | ○ |
...
| W5 · Kernel-module surface | · | · | · | · | · | △ | · | · | · | · |
| W5 · Export reachability | · | · | · | · | · | ✓1 | · | · | · | · |
...
| W5 · Reachability (libutil-0.9.30.so) | — | — | — | — | — | — | — | △ | △ | △ |
...
| `DVRF-v03` | `57c12e70` | mipsel | DVRF_v03.bin | 25/29 |
| `IMOU-Ranger-2C` | `f3618503` | arm | IMOU-Ranger-2C.bin | 25/29 |
| `Obsbot-meetse-OA-E-P` | `4cd8d78c` | arm | Obsbot_meetse_OA_E_PW204_4.6.4.1_release.bin | 21/21 |
| `Tenda-Camera` | `2b5fe786` | arm | Tenda-Camera.bin | 24/28 |
| `TP-Link-MR3220-v2-3-` | `d2587cb0` | mips | TP-Link-MR3220_v2_3.17.1.bin | 26/30 |
| `TP-Link-WDR3600v1-3-` | `398d50ef` | mips | TP-Link-WDR3600v1_3.14.3.bin | 26/30 |
| `TP-Link-WR940Nv6-3-2` | `c42ab6f2` | mips | TP-Link-WR940Nv6_3.20.1.bin | 24/28 |
...
| Etiqueta | ID | Arquitectura | Fichero | Cobertura |
|---|---|---|---|---:|
| `GL-iNet-BE3600-4-9-0` | `81154df7` | arm64 | GL.iNet-BE3600_4.9.0.bin | 26/30 |

## rtos

Muestras: `Contiki-STM32F4-Disc`, `Xiaomi-Repeater-2018`, `Xiaomi-Repeater-2023`, `Zephyr-STM32L072-But`.

| Etapa | Contiki-STM32F4-Disc | Xiaomi-Repeater-2018 | Xiaomi-Repeater-2023 | Zephyr-STM32L072-But |
|---|---:|---:|---:|---:|
| W7 · Bare-metal / RTOS | ✓1 | ✓1 | ✓1 | ✓1 |
| Static · Certificates | ○ | ○ | ○ | ○ |
...
Muestras: `Framework-QMK-ANSI-v`.

| Etapa | Framework-QMK-ANSI-v |
|---|---:|
| W1 · Extraction | △ |
| Static · Certificates | ○ |
| Static · U-Boot env | ○ |
...
| Etiqueta | ID | Arquitectura | Fichero | Cobertura |
|---|---|---|---|---:|
| `Framework-QMK-ANSI-v` | `b0cd7770` | unknown | Framework-QMK-ANSI-v0.3.1.bin | 7/7 |
